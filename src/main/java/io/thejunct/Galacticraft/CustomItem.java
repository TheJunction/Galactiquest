...
enum CustomItem {
    ...
    SPACESHIP_HEAD(1561),
    SPACESHIP_CONTROL_THRUST(ChatColor.GREEN + "Thrust", "Right click to move forward.", 1560),
    SPACESHIP_CONTROL_REVERSE(ChatColor.RED + "Reverse", "Right click to move backwards.", 1559),
